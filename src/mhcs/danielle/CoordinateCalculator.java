...
/**
 * Calculates the grid position based on (x, y) coordinates.
...
public class CoordinateCalculator {
	...
	/**
	 * ycoorMap is the coordinate of the 
	 * module on landing area map.
	 */
